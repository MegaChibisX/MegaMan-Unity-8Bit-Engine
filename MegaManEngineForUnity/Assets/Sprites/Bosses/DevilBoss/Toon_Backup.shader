// Source: https://roystan.net/articles/toon-shader.html (with minor modifications made)

Shader "MegaManBareBonesEngine/Toon_Backup"
{
	Properties
	{
	...
	_ShadowColor("Shadow Color", Color) = (0.4,0.4,0.4,1)
		...
		SubShader
		{
			...
			float4 frag(v2f i) : SV_Target
			{
				...
				return ((light + _AmbientColor + specular + rim) * _Color + (1 - light) * _ShadowColor) * sample;
			}
			ENDCG
		}
